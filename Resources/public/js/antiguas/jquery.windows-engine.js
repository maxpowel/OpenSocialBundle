...
//He añadido ui-widget-content al cuerpo de la ventana
//El evento on windowclose y el closeNow
...
jQuery.extend({
    ...
    newWindow: function(options) {
        ...
        $windowContent = $('<div class="window-content ui-widget-content"></div>');
        ...
        $windowCloseButton.bind('closeNow', function(e) {
            options.onWindowClose = null;
            $windowCloseButton.trigger('click',{});
        });
    ...
    closeWindow: function(id) {
        $("#" + id + " .window-closeButton").trigger('closeNow',{});
