//He modificado la parte de customNotFound
(function() {
  /*
  ...
  */  var $, Chosen, SelectParser, get_side_border_padding, root;
  ...
  Chosen = (function() {
    ...
    Chosen.prototype.no_results = function(terms) {
      var no_results_html;
      if(this.options.customNotFound != null){
          no_results_html = this.options.customNotFound(terms);
      }else{
          no_results_html = $('<li class="no-results">No se encontró "<span></span>"</li>');
