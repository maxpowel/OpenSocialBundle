...
/* Handle keystrokes. */
	...
	_connectColorPicker: function(target, inst) {
		...
		// Create sample span
		inst._sampleSpan = $('<span class="ColorPickerDivSample ui-corner-all" style="background-color:' + inst._input[0].value + ';height:' + inst._input[0].offsetHeight + ';">&nbsp;</span>');
...
$.extend(ColorPickerInstance.prototype, {
	...
	_generateColorPicker: function() {
        ...
        var width = 18;
	    var html = "<table class='ui-widget-content ui-corner-all portlet-content' border='1px' cellspacing='0' cellpadding='0'>";
	    
	    for (var i=0; i<total; i++)
	    {
		    if ((i % width) == 0) { html += "<tr>"; }
		    
		    html += '<td class="color ui-widget-content" title="' + colors[i] + '" style="background-color:' + colors[i] + '"><label style="background-color:' + colors[i] + '">&nbsp;&nbsp;&nbsp;</label></td>';
		...
		html += '<tr><td title="" style="background-color:#999" class="color ui-widget-content" colspan="' + width + '" align="center"><label>Normal</label></td></tr>'
